...
const tasks = [
    { id: 11, name: 'Follow on Twitter', url: 'https://x.com/smart_openet', points: 50, icon: 'fab fa-twitter' },
    { id: 12, name: 'Join DePinsDirect Telegram', url: 'https://t.me/depinsdirect', points: 50, icon: 'fab fa-telegram' },
    { id: 13, name: 'Visit Website', url: 'https://www.nativeopen.x', points: 50, icon: 'fas fa-globe' },
